...
// const miceditorUrl = "https://entibo.github.io/miceditor/"
const miceditorUrl = "http://localhost:8080"
console.log(miceditorUrl)
...
;(async () => {
  ...
  await page.evaluate(() => {
    ...
    document.querySelector(".mapBorder").style.visibility = "hidden"
  })
  ...
  await setXML(xml1)
  timeLog("Input xml1")
  await svgEl.screenshot({ path: "screenshot.png" })
  timeLog("Aquired screenshot1")
  await setXML(xml2)
  timeLog("Input xml2")
  await svgEl.screenshot({ path: "screenshot2.png" })
  timeLog("Aquired screenshot2")
